...
| cost | cost | DECIMAL(12,2) | False | `>= 0` | `cast(cost, decimal)` |  |
...
| active | is_active | BOOLEAN | False | `` | `direct` |  |
...
| parent_ref | parent_id | VARCHAR(50) | True | `FOREIGN_KEY(Location.location_id)` | `direct` |  |
