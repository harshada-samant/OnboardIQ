...
from backend.agents.migration_generator_agent import run_migration_generator_agent
from backend.agents.migration_reviewer_agent import run_migration_reviewer_agent
from backend.agents.migration_execution_agent import run_migration_execution_agent
from backend.agents.migration_validation_agent import run_migration_validation_agent
...
def main() -> int:
    ...
    agent_steps = [
        ...
        ("migration_generator", run_migration_generator_agent, (context,), {"verbose": True}),
        ("migration_reviewer", run_migration_reviewer_agent, (context,), {"verbose": True}),
        ("migration_execution", run_migration_execution_agent, (context,), {"verbose": True}),
        ("migration_validation", run_migration_validation_agent, (context,), {"verbose": True}),
    ]
