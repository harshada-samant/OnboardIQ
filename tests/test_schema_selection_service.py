...
def test_service_all():
    ...
    try:
        ...
        assert get_schema_options() == ["target_schema.json"]
        ...
        expected_options = ["oracle.json", "sap.json", "target_schema.json"]
        ...
        assert get_user_schema_selection(user1_id) == "target_schema.json"
